...
class UCF101(Dataset):
    def __init__(self, frames_path, labels_path, frame_size, sequence_length, setname='train',
        ...
        self.data_paths = []
        # this value will use for CategoriesSampler class, because this UCF101 can't sample the data for few-shot learning
        self.classes = []
        self.labels = {}
        lines = csv.readlines()
        for line in lines:
    ...
    def __getitem__(self, index):
        ...
        # 2. when sampled too many frames of video rather than setted sequence length, _frame_sampler function will be solve this problem
